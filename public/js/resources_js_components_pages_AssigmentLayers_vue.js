(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_pages_AssigmentLayers_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/AssigmentLayers.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/AssigmentLayers.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************************/
...
/* harmony export */ });
/* harmony import */ var _core_Loader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core/Loader */ "./resources/js/components/core/Loader.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    deleteItem: function deleteItem(layer) {
      var _this = this;
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          axios.post("/role/deleteLayer", {
            id_role: _this.selectRole,
            id_layer: layer.id
            ...
            _this.$toastr.s("Delete layer", "Assigment");
          })["catch"](function () {
            _this.loadingDelete = false;

            _this.$toastr.e("Cannot delete layer", "Error");
          });
        }
      });
    },
    getRoles: function getRoles() {
      ...
      axios.get("/role/getAll").then(function (response) {
        _this2.roles = response.data.roles;

        if (response.data.roles.length) {
          _this2.roles = _this2.roles.map(function (item) {
            return {
              id: item.id,
              name: item.name
            };
          });
          _this2.selectRole = _this2.roles[0].id;
    ...
    getAllLayers: function getAllLayers() {
      ...
      this.loadingTable = true;
      axios.get("/layer/getAll").then(function (response) {
        _this3.allLayers = response.data.layers;
    ...
    changeRole: function changeRole() {
      ...
      this.loadingTable = true;
      this.layers = [];
      axios.get("/role/getLayerPermissionsByRoleId/" + this.selectRole).then(function (response) {
        var tmp = response.data.rolesLayers[0].get_layers_relation;
        var layer = {};
        tmp.forEach(function (element) {
          ...
          _this4.layers.push(layer);

          layer = {};
        });
        _this4.addLayers = _this4.layers.map(function (item) {
          return item.id;
        });
        _this4.loadingTable = false;
      })["catch"](function (e) {
        _this4.$toastr.e("Cannot get role`s layers", "Error"); // console.log(e);
    ...
    submit: function submit(item) {
      ...
      var data = JSON.stringify(this.layers);
      axios.post("/role/assigmentLayers", {
        id_role: this.selectRole,
        layers: data
      }).then(function (response) {
        _this5.loadingAssign = false;

        _this5.$toastr.s("Assigment layer", "Assigment");

        _this5.dialog = false;
      })["catch"](function () {
        _this5.loadingAssign = false;

        _this5.$toastr.e("Cannot assigment layer", "Error");
      });
    },
    addAssigmentLayers: function addAssigmentLayers() {
      var _this6 = this;

      this.loadingAdd = true;
      var data = JSON.stringify(this.addLayers);
      axios.post("/role/addAssigmentLayers", {
        id_role: this.selectRole,
        layers: data
      }).then(function (response) {
        _this6.getAllLayers();

        _this6.$toastr.s("Add layer", "Assigment");

        _this6.dialog = false;
        _this6.loadingAdd = false;
      })["catch"](function () {
        _this6.loadingAdd = false;

        _this6.$toastr.e("Cannot add layer(s)", "Error");
      });
    }
  },
  ...
  components: {
    Loader: _core_Loader__WEBPACK_IMPORTED_MODULE_0__.default
  }
});
...
/***/ "./resources/js/components/pages/AssigmentLayers.vue?vue&type=script&lang=js&":
/*!************************************************************************************!*\
  !*** ./resources/js/components/pages/AssigmentLayers.vue?vue&type=script&lang=js& ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AssigmentLayers_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AssigmentLayers.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/AssigmentLayers.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AssigmentLayers_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/components/pages/AssigmentLayers.vue?vue&type=template&id=fe3c8d8e&":
/*!******************************************************************************************!*\
  !*** ./resources/js/components/pages/AssigmentLayers.vue?vue&type=template&id=fe3c8d8e& ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AssigmentLayers_vue_vue_type_template_id_fe3c8d8e___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AssigmentLayers_vue_vue_type_template_id_fe3c8d8e___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AssigmentLayers_vue_vue_type_template_id_fe3c8d8e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AssigmentLayers.vue?vue&type=template&id=fe3c8d8e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/AssigmentLayers.vue?vue&type=template&id=fe3c8d8e&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/AssigmentLayers.vue?vue&type=template&id=fe3c8d8e&":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/AssigmentLayers.vue?vue&type=template&id=fe3c8d8e& ***!
  \*********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _c(
    ...
    [
      _c(
        ...
        { attrs: { flat: "" } },
        [
          _c("v-toolbar-title", [_vm._v(_vm._s(_vm.$t("ASSIGMENT_LAYERS")))]),
          _vm._v(" "),
          _c("v-divider", {
            staticClass: "mx-4",
          ...
          _c(
            "v-btn",
            {
              attrs: { tile: "", color: "success", loading: _vm.loadingAdd },
              on: {
                  ...
                  return [
                    _c("thead", [
                      _c("tr", [
                        ...
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.$t("READ")))]),
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.$t("ADDING")))]),
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.$t("EDITING")))]),
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.$t("DELETING")))]),
                        _vm._v(" "),
                              ...
                              [
                                _c("v-checkbox", {
                                  ...
                                  model: {
                                    value: layer.read,
                                    callback: function($$v) {
                                      _vm.$set(layer, "read", $$v)
                                    },
                                    expression: "layer.read"
                                  }
                                })
                              ],
                              1
                              ...
                              [
                                _c("v-checkbox", {
                                  ...
                                  model: {
                                    value: layer.write,
                                    callback: function($$v) {
                                      _vm.$set(layer, "write", $$v)
                                    },
                                    expression: "layer.write"
                                  }
                                })
                              ],
                              1
                              ...
                              [
                                _c("v-checkbox", {
                                  ...
                                  model: {
                                    value: layer.delete,
                                    callback: function($$v) {
                                      _vm.$set(layer, "delete", $$v)
                                    },
                                    expression: "layer.delete"
                                  }
                                })
                              ],
                              1
      ...
      _c(
        ...
        [
          _c(
            "v-card",
            [
              _c("v-card-title", [_vm._v("Добавить слои")]),
              _vm._v(" "),
              _c("v-divider"),
              _vm._v(" "),
              _c(
...
/***/ "./resources/js/components/pages/AssigmentLayers.vue":
/*!***********************************************************!*\
  !*** ./resources/js/components/pages/AssigmentLayers.vue ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _AssigmentLayers_vue_vue_type_template_id_fe3c8d8e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AssigmentLayers.vue?vue&type=template&id=fe3c8d8e& */ "./resources/js/components/pages/AssigmentLayers.vue?vue&type=template&id=fe3c8d8e&");
/* harmony import */ var _AssigmentLayers_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AssigmentLayers.vue?vue&type=script&lang=js& */ "./resources/js/components/pages/AssigmentLayers.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _AssigmentLayers_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _AssigmentLayers_vue_vue_type_template_id_fe3c8d8e___WEBPACK_IMPORTED_MODULE_0__.render,
  _AssigmentLayers_vue_vue_type_template_id_fe3c8d8e___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (baseMixins.extend({
  ...
  computed: {
    ...
    __cachedDeterminate() {
      return this.$createElement('div', this.setBackgroundColor(this.color, {
        ...
        style: {
          width: (0,_util_helpers__WEBPACK_IMPORTED_MODULE_6__.convertToUnit)(this.normalizedValue, '%')
        }
      }));
    },
    ...
    __cachedStream() {
      ...
      return this.$createElement('div', this.setTextColor(this.color, {
        ...
        style: {
          width: (0,_util_helpers__WEBPACK_IMPORTED_MODULE_6__.convertToUnit)(100 - this.normalizedBuffer, '%')
        }
      }));
    },
    ...
    backgroundStyle() {
      ...
      return {
        ...
        [this.isReversed ? 'right' : 'left']: (0,_util_helpers__WEBPACK_IMPORTED_MODULE_6__.convertToUnit)(this.normalizedValue, '%'),
        width: (0,_util_helpers__WEBPACK_IMPORTED_MODULE_6__.convertToUnit)(this.normalizedBuffer - this.normalizedValue, '%')
      };
    },
    ...
    computedTransition() {
      return this.indeterminate ? _transitions__WEBPACK_IMPORTED_MODULE_7__.VFadeTransition : _transitions__WEBPACK_IMPORTED_MODULE_7__.VSlideXTransition;
    },
    ...
    styles() {
      ...
      if (!this.indeterminate && parseFloat(this.normalizedBuffer) !== 100) {
        styles.width = (0,_util_helpers__WEBPACK_IMPORTED_MODULE_6__.convertToUnit)(this.normalizedBuffer, '%');
      }
  ...
  methods: {
    genContent() {
      const slot = (0,_util_helpers__WEBPACK_IMPORTED_MODULE_6__.getSlot)(this, 'default', {
  ...
  render(h) {
    const data = {
      ...
      style: {
        ...
        height: this.active ? (0,_util_helpers__WEBPACK_IMPORTED_MODULE_6__.convertToUnit)(this.height) : 0,
