...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    emailErrors: function emailErrors() {
      ...
      !this.$v.form.email.maxLength && errors.push("Email must be at most 30 characters long");
    ...
    passwordErrors: function passwordErrors() {
      ...
      !this.$v.form.password.maxLength && errors.push("Password must be at most 30 characters long");
  ...
  methods: {
    showRPermissions: function showRPermissions() {
      var _this = this;

      // console.log(this.form.roles);
      if (this.form.roles.length) {
        axios.post("/role/getPermissionsByRoles", {
          roles: this.form.roles
        }).then(function (response) {
          _this.loading = false; // this.users = response.data.users;
          // console.log(response.data);

          _this.permissionsByRoles = response.data; // console.log(this.users);
          ...
          _this.$toastr.e("Cannot load users", "Error");
        });
      } else {
    ...
    getUsers: function getUsers(search) {
      ...
      axios.get("/user/getAll/", {
        ...
        _this2.users = response.data.users; // console.log(this.users);
        // let tmp = this.users.map(item => {
        //     return item.roles.map(role => {
        //         return (role = role.name);
        //     });
        ...
        _this2.$toastr.e("Cannot load users", "Error");
      });
    },
    viewItem: function viewItem(user) {
      ...
      this.dialog = true;
      this.form.fill(user);
      this.form.roles = this.form.roles.map(function (role) {
        return role.name;
      });
      this.form.permissions = this.form.permissions.map(function (permission) {
    ...
    getRoles: function getRoles() {
      ...
      axios.get("/role/getAll").then(function (response) {
        ...
        _this3.roles = _this3.roles.map(function (item) {
          return item.name;
    ...
    getPermissions: function getPermissions() {
      ...
      axios.get("/permission/getAll").then(function (response) {
        ...
        _this4.permissions = _this4.permissions.map(function (item) {
          return item.name;
        });
      });
    },
    ...
    createItem: function createItem() {
      ...
      this.$v.$touch(); // console.log(this.$v);
      // console.log(this.$v.form);
      // console.log(this.$v.form.name);
      // console.log(this.$v.form.email);
      // console.log(this.$v.form.password);

      if (!this.$v.form.name.$error && !this.$v.form.email.$error && !this.$v.form.password.$error) {} else {
        return;
      }

      this.action = "Creating user...";
      this.load = false;
      this.form.post("/account/create").then(function (response) {
        _this5.load = true;

        _this5.$toastr.s("User created", "Created");
        ...
        _this5.$toastr.e("Cannot create user", "Error");
      });
    },
    editItem: function editItem(user) {
      ...
      this.dialog = true;
      this.form.reset();
      this.form.fill(user); // this.form.role = user.roles[0].id;

      this.form.roles = user.roles.map(function (role) {
        return role.name;
      });
    ...
    updateItem: function updateItem() {
      ...
      this.load = false;
      this.form.put("/account/update/" + this.form.id).then(function (response) {
        _this6.load = true;

        _this6.$toastr.s("User information updated successfully", "Created");
        ...
        _this6.$toastr.e("Cannot update user information", "Error");
      });
    },
    deleteItem: function deleteItem(user) {
      var _this7 = this;
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios["delete"]("/user/delete/" + user.id).then(function () {
            toast.fire("Deleted!", user.name + " has been deleted sucessfully.", "success");

            _this7.getUsers();
          })["catch"](function () {
            toast.fire("Deleted!", user.name + " was unable to be remove, try again later", "error");
          });
        }
      });
    }
  ...
  return _c(
    ...
    [
      _c(
        ...
        { attrs: { flat: "" } },
        [
          _c("v-toolbar-title", [_vm._v(_vm._s(_vm.$t("USERS")))]),
          _vm._v(" "),
          _c("v-divider", {
            staticClass: "mx-4",
          ...
          _c("v-text-field", {
            ...
            on: {
              change: function($event) {
                return _vm.getUsers(_vm.search)
              },
                  ...
                  return [
                    _c("thead", [
                      _c("tr", [
                        ...
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.$t("DATE_CREATED")))]),
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.$t("DATE_UPDATED")))])
                      ])
                    ]),
                    _vm._v(" "),
                    _c(
                      ...
                      [
                        !_vm.users.length
                          ? _c("h3", [_vm._v(_vm._s(_vm.$t("NO_DATA")))])
                          : _vm._e(),
                        _vm._v(" "),
                        _vm._l(_vm.users, function(user) {
                          return _c("tr", { key: user.id }, [
                            ...
                            _c("td", [
                              _vm._v(
                                "\n                        " +
                                  _vm._s(_vm._f("date")(user.updated_at)) +
                                  "\n                    "
                              )
                            ])
                          ])
                                          ...
                                          ? _c(
                                              ...
                                              [
                                                _c(
                                                  ...
                                                  [
                                                    _c("v-subheader", [
                                                      _vm._v("Все разрешения")
                                                    ]),
                                                    _vm._v(" "),
                                                    _vm._l(
                                                      _vm.form.AllPermissions,
                                                      function(permission) {
                                                        return _c(
                                                          "v-item",
                                                          {
...
/* harmony import */ var vuetify_lib_components_VItemGroup__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! vuetify/lib/components/VItemGroup */ "./node_modules/vuetify/lib/components/VItemGroup/VItem.js");
/* harmony import */ var vuetify_lib_components_VItemGroup__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! vuetify/lib/components/VItemGroup */ "./node_modules/vuetify/lib/components/VItemGroup/VItemGroup.js");
...
/* harmony import */ var vuetify_lib_components_VDataTable__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! vuetify/lib/components/VDataTable */ "./node_modules/vuetify/lib/components/VDataTable/VSimpleTable.js");
