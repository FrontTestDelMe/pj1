(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_pages_Layers_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/Layers.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/Layers.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    ...
    selected_category: function selected_category(catId) {
      this.sub_category_choose = this.sub_categories.filter(function (sc) {
  ...
  methods: {
    initialize: function initialize() {
      ...
      this.loading = true;
      axios.get("/layer/get_layers").then(function (response) {
        ...
        _this.$toastr.e("Cannot load layers", "Error");
      });
      this.getCategories();
    ...
    getCategories: function getCategories() {
      ...
      axios.get("/categories/getAll").then(function (response) {
        ...
        _this2.$toastr.e("Cannot load categories", "Error");
      });
    },
    getSubCategories: function getSubCategories() {
      ...
      this.loading = true;
      axios.get("/subcategory/getAll").then(function (response) {
        _this3.loading = false;
        _this3.sub_categories = response.data.subCategory;
      })["catch"](function (err) {
        _this3.loading = false;

        _this3.$toastr.e("Cannot load categories", "Error");
      });
    },
    editItem: function editItem(item) {
      this.editedIndex = this.layers.indexOf(item); // console.log(item);
      ...
      this.selected_category = item.get_sub_categories_relation[0].get_categories_relation[0].id;
      this.form.selected_sub_category = item.get_sub_categories_relation[0].id;
      this.editMode = true;
      this.dialog = true;
    },
    deleteItem: function deleteItem(item) {
      ...
      this.editedIndex = this.layers.indexOf(item); // this.form = Object.assign({}, item);
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios["delete"]("/layer/delete/" + item.id).then(function () {
            toast.fire("Deleted!", item.name + " has been deleted sucessfully.", "success"); // Fire.$emit("loadUser");

            _this4.initialize();
          })["catch"](function () {
            toast.fire("Deleted!", item.name + " was unable to be remove, try again later", "error");
          });
        }
    ...
    updateItem: function updateItem() {
      ...
      this.loading = true;
      this.form.put("/layer/update/" + this.form.id).then(function (response) {
        _this7.loading = false;

        _this7.$toastr.s("Category information updated successfully", "Updated");
        ...
        _this7.$toastr.e("Cannot update category information", "Error");
      });
    },
    createItem: function createItem() {
      var _this8 = this;

      this.form.post("/layer/create").then(function (response) {
        _this8.$toastr.s("Layer created", "Created"); // Fire.$emit("loadLayer");
        ...
        if (error.response.status === 422) {
          ...
          _this8.$toastr.e(msg, "Error");
        } else {
          _this8.$toastr.e("Cannot create layer", "Error");
        }
      });
      this.initialize();
      this.close();
...
/***/ "./resources/js/components/pages/Layers.vue?vue&type=script&lang=js&":
/*!***************************************************************************!*\
  !*** ./resources/js/components/pages/Layers.vue?vue&type=script&lang=js& ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Layers_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Layers.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/Layers.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Layers_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/components/pages/Layers.vue?vue&type=template&id=da90e150&":
/*!*********************************************************************************!*\
  !*** ./resources/js/components/pages/Layers.vue?vue&type=template&id=da90e150& ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Layers_vue_vue_type_template_id_da90e150___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Layers_vue_vue_type_template_id_da90e150___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Layers_vue_vue_type_template_id_da90e150___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Layers.vue?vue&type=template&id=da90e150& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/Layers.vue?vue&type=template&id=da90e150&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/Layers.vue?vue&type=template&id=da90e150&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/pages/Layers.vue?vue&type=template&id=da90e150& ***!
  \************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        fn: function() {
          return [
            _c(
              ...
              { attrs: { flat: "" } },
              [
                _c("v-toolbar-title", [_vm._v(_vm._s(_vm.$t("LAYERS")))]),
                _vm._v(" "),
                _c("v-divider", {
                  staticClass: "mx-4",
                                    ...
                                    _c(
                                      ...
                                      [
                                        _c("v-select", {
                                          ...
                                          model: {
                                            value:
                                              _vm.form.selected_sub_category,
                                            callback: function($$v) {
                                              _vm.$set(
                                                _vm.form,
...
/***/ "./resources/js/components/pages/Layers.vue":
/*!**************************************************!*\
  !*** ./resources/js/components/pages/Layers.vue ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Layers_vue_vue_type_template_id_da90e150___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Layers.vue?vue&type=template&id=da90e150& */ "./resources/js/components/pages/Layers.vue?vue&type=template&id=da90e150&");
/* harmony import */ var _Layers_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Layers.vue?vue&type=script&lang=js& */ "./resources/js/components/pages/Layers.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _Layers_vue_vue_type_template_id_da90e150___WEBPACK_IMPORTED_MODULE_0__.render,
  _Layers_vue_vue_type_template_id_da90e150___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/pages/Layers.vue"
    ...
    genDefaultSimpleRow(item, index, classes = {}) {
      ...
      if (this.showSelect) {
        ...
        scopedSlots['data-table-select'] = slot ? () => slot({ ...data,
          isMobile: this.isMobile
        }) : () => this.$createElement(_VCheckbox_VSimpleCheckbox__WEBPACK_IMPORTED_MODULE_11__.default, {
