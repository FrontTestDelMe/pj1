...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    login: function login() {
      ...
      // return;
      this.form.post("/user/login").then(function (response) {
        console.log(response.data); // this.$store.commit("updateUser", response.data);

        _this.$store.commit("updateUser", response.data);

        _this.$store.commit("updateLogged", true);

        axios.post("/user/getJsPermissions").then(function (response) {
          // console.log(JSON.parse(response.data.jsPermissions));
          window.Laravel = {
            jsPermissions: JSON.parse(response.data.jsPermissions),
        ...
        _this.$toastr.s("Успешно", "Добро пожаловать");

        _this.form.reset();

        _this.$router.push("/");
      })["catch"](function () {
        _this.$toastr.e("Ошибка", "Что-то не так");
      });
    }
  },
  computed: {
...
var render = function() {
  ...
  return _c(
    ...
    { attrs: { width: "330" } },
    [
      _c("v-card-title", { staticClass: "card__title" }, [
        _vm._v(
      ...
      _c("v-card-text", [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("v-checkbox", {
              attrs: { label: "Remember me", name: "remember" },
              model: {
